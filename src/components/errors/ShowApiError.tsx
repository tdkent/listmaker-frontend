...
const ShowApiError = ({ errorData }: Props) => {
  ...
  if (errorData) {
    ...
    return (
      <div
        id="api-error"
        className="flex flex-row justify-between items-center mb-4 px-2 pr-1.5 py-2.5 border rounded-md text-sm text-white font-semibold bg-tomato hover:cursor-pointer"
        onClick={handleClick}>
