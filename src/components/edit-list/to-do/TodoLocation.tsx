            ...
            {data.map((place) => {
              return (
                <li
                  ...
                  className="flex flex-row items-center text-sm my-1.5 pl-2 hover:bg-blue-600 hover:text-white hover:cursor-pointer dark:hover:bg-gray-800 dark:hover:text-gray-300"
                >
                  <ChevonRight />
                  {place.description}
                </li>
